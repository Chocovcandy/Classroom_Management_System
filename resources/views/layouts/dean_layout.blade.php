        ...
        <div class="layout">
            ...
            <aside class="sidebar closed" id="sidebar">
                <ul class="sidebar-menu">
                    <li><a href="{{ route('dean.dashboard') }}" class="sidebar-link" id="sidebarlinks">
                    ...
                    <li><a href=" " class="sidebar-link" id="sidebarlinks">
                        <svg xmlns="http://www.w3.org/2000/svg"width="512" height="512" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="size-6">
