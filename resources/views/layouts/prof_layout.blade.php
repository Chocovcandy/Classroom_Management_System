        ...
        <div class="layout">
            ...
            <aside class="sidebar closed" id="sidebar">
                <ul class="sidebar-menu">
                    <li><a href="{{ route('professor.dashboard') }}" class="sidebar-link" id="sidebarlinks">
                    ...
                    <li><a href="{{ route('professor.schedule.index') }}" class="sidebar-link" id="sidebarlinks">
                    ...
                    <li>
                        <a href="{{ route('professor.class-groups.index') }}"
                            class="sidebar-link"
                            id="sidebarlinks">
