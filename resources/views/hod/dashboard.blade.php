...
<div class="dashboard-container">
    ...
    <div class="dashboard-left">
        ...
        <div class="stat-container">
            ...
            <a href="{{ route('hod.professors.index') }}" class="stat-card">
            ...
            <a href="{{ route('hod.courses.index') }}" class="stat-card">
                ...
                <div class="stat-icon">
                    <svg
                        ...
                        <path
                            fill-rule="evenodd"
                            d="M6 2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H6Zm1 5a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2H8a1 1 0 0 1-1-1Zm1 4a1 1 0 1 0 0 2h8a1 1 0 0 0 0-2H8Zm0 4a1 1 0 1 0 0 2h5a1 1 0 0 0 0-2H8Z"
                            clip-rule="evenodd" />
                    </svg>
                </div>
            ...
            <a href="{{ route('hod.schedules.index') }}" class="stat-card">
