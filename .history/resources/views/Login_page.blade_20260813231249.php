        ...
        @guest
            ...
            <div class="auth-choice-container">
                <div class="auth-choice-header">
                    ...
                    <img src="{{ asset('images/Life_circle_blue_LG.png') }}" alt="School Logo" class="auth-school-logo">

                    <span class="auth-choice-label">
                    ...
                    @if (Route::has('register'))
                        ...
                        <div class="auth-choice-card">
                            ...
                            <div class="auth-choice-content">
                                ...
                                <a href="{{ route('register') }}" class="auth-choice-btn student-btn">
