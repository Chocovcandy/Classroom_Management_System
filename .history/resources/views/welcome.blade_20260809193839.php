...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="container">
        <main class="main">
            ...
            <section class="schedule section container" id="schedule">
                <div class="schedule__container grid">
                    ...
                    <div class="schedule__data">
                        ...
                        <p class="schedule__description">Create and publish class schedules based on department and
