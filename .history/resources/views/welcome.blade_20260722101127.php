...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="#" class="nav__logo">Life University</a>
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    ...
                    <li class="nav__item">
                        <a href="#services" class="nav__link">Features</a>
                    </li>
                    <li class="nav__item">
                ...
                <div class="home__container container grid">
                    ...
                    <div class="home__data">
                        <h1 class="home__title">
                            Smart Classroom & Academic <br>
                            Collaboration System
                        </h1>
                        <p class="home__description">
                            Manage schedules, organize classes, and support teamwork across the university with ease.
                        </p>
...
<div class="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100 flex items-center justify-center px-4">

    <div
        class="w-full max-w-md rounded-3xl bg-white/80 backdrop-blur-xl border border-white/30 shadow-2xl p-10">

        <!-- Logo -->
        <div class="flex justify-center mb-6">
            <div
                class="h-20 w-20 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-lg">
        ...
        <p class="text-center text-gray-500 mt-3 mb-8 leading-relaxed">
            Manage students, professors, departments and schedules from one place.
        </p>
        ...
        @guest
            <div class="space-y-4">
                ...
                <a href="{{ route('login') }}"
                    class="block w-full rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 py-3 text-center font-semibold text-white shadow-lg hover:shadow-xl hover:scale-[1.02] transition duration-300">
                    Login
                </a>

                @if (Route::has('register'))
                    <a href="{{ route('register') }}"
                        class="block w-full rounded-xl border border-gray-200 bg-white py-3 text-center font-medium text-gray-700 hover:bg-gray-50 transition">
                        Register as Student
                    </a>
                @endif
        ...
        @auth
            ...
            <div class="space-y-5">
                ...
                <div
                    class="rounded-2xl bg-blue-50 border border-blue-100 p-4 text-center">
                    ...
                    <span
                        class="inline-block mt-3 rounded-full bg-blue-100 px-4 py-1 text-sm font-medium text-blue-700">
                        {{ $role }}
                    </span>
                ...
                @if ($role === 'Admin')
                    <a href="{{ route('admin.dashboard') }}"
                        class="block w-full rounded-xl bg-gradient-to-r from-emerald-500 to-green-600 py-3 text-center font-semibold text-white hover:shadow-lg transition">
                        Go to Dashboard
                    </a>
