                    ...
                    <div class="w-full max-w-md bg-white rounded-3xl border border-gray-200 shadow-xl p-10">
                        ...
                        @auth
                            ...
                            <div class="mt-8">
                                ...
                                @if ($role === 'Admin')
                                <a href="{{ route('admin.dashboard') }}" @elseif ($role === 'Dean') <a
                                href="{{ route('dean.dashboard') }}" @elseif ($role === 'HoD') <a
                                    href="{{ route('hod.dashboard') }}" @elseif ($role === 'Professor') <a
                                    href="{{ route('professor.dashboard') }}" @elseif ($role === 'Student') <a
