...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="container">
        <main class="main">
            ...
            <section class="services__container services__container--two grid" id="services">
                ...
                <div class="services__container grid">
                    ...
                    <div class="card__container">
                        ...
                        <p class="services__description">Publish announcements to all users in the system to deliver important updates and
                            information.
                    </div>
                    ...
                    <div class="card__container">
                        ...
                        <p class="services__description">Create and publish class schedules based on department and
                            academic year while preventing classroom and subject conflicts.</p>
                    </div>
